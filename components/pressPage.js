...
async function pressUploadImage(docId, storageRef) {
  ...
  let press_mr_application_received_url = URLEMAILTEMPLATES.URLEMAILFOLDER + URLEMAILTEMPLATES.URLMRAPPLICATIONRECEIVED_EN;
  let press_ms_application_received_url = URLEMAILTEMPLATES.URLEMAILFOLDER + URLEMAILTEMPLATES.URLMSAPPLICATIONRECEIVED_EN;
